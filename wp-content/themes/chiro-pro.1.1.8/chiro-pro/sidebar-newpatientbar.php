<?php if ( ! dynamic_sidebar('newpatientbar')) : ?>
	<h2><?php _e('You need to add a custom menu widget in the New Patient Sidebar widget area. (Dashboard --> Appearance --> Widgets)' , 'chiro-pro'); ?></h2>
<?php endif; ?>
