			...
			<div id="container1">	
				<header>			
					...
					<div class="info-box" id="your-email">
						...
						<p><a href="mailto:<?php echo is_email(get_theme_mod('email' , 'user@domain.com')); ?>"><?php echo is_email(get_theme_mod('email' , 'user@domain.com')); ?></a></p>
					</div>
					<div class="info-box" id="phone">
						<h4><?php _e('PHONE' , 'chiro-pro'); ?></h4>
						<p><a href="tel:<?php echo esc_attr(get_theme_mod('phone_link' , '5555555555')); ?>"><?php echo esc_html(get_theme_mod('phone' , '555-555-5555')); ?></a></p>
					</div>
				</header>
